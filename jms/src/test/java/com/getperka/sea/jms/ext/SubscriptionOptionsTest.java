...
public class SubscriptionOptionsTest {
  ...
  public void test() throws Exception {
    ...
    for (Method m : SubscriptionOptions.class.getDeclaredMethods()) {
      ...
      if (String.class.equals(returnType)) {
        ...
        arg = ((Number) m.getDefaultValue()).intValue() + 1;
      } else if (long.class.equals(returnType)) {
        arg = ((Number) m.getDefaultValue()).longValue() + 1;
  ...
  public void testCompareToReal() {
    SubscriptionOptions real = getClass().getAnnotation(Subscriptions.class).value()[0].options();
