...
/**
 * Issues events to receivers in a known ordering. The order is defined by order of the
 * {@link Collection} passed into {@link OrderedDispatch#fire(java.util.Collection)}.
 */
@Documented
